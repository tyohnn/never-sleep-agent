...
5. Default skills → [`references/default-skills.md`](references/default-skills.md)
6. Wake entry → [`references/wake-protocol.md`](references/wake-protocol.md)
7. Collision → [`references/collision-and-merge.md`](references/collision-and-merge.md)
8. Notion → [`references/notion-schema.md`](references/notion-schema.md)
9. Slack → [`references/slack-protocol.md`](references/slack-protocol.md)
